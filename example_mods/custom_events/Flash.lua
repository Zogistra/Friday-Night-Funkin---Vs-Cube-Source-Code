...
function onEvent(name, value1, value2)
	if name == 'Flash' then
		...
		if colour == 5 then
			...
			setObjectCamera('flash', 'other');
			addLuaSprite('flash', true);
			doTweenColor('flashcolour', 'flash', 'FFFF00', 0.01, 'linear');
			doTweenAlpha('flashalpha', 'flash', 0, duration, 'linear');
		end
		if colour == 6 then
			makeLuaSprite('flash', 'white', 0, 0);
			setObjectCamera('flash', 'other');
			addLuaSprite('flash', true);
			doTweenColor('flashcolour', 'flash', '00CCFF', 0.01, 'linear');
			doTweenAlpha('flashalpha', 'flash', 0, duration, 'linear');
                end
		if colour == 7 then
			makeLuaSprite('flash', 'white', 0, 0);
			...
			setObjectCamera('flash', 'other');
			addLuaSprite('flash', true);
			doTweenColor('flashcolour', 'flash', 'FF007B', 0.01, 'linear');
			doTweenAlpha('flashalpha', 'flash', 0, duration, 'linear');
                end
                if colour == 9 then
			makeLuaSprite('flash', 'white', 0, 0);
			setObjectCamera('flash', 'other');
			addLuaSprite('flash', true);
			doTweenColor('flashcolour', 'flash', 'FF7300', 0.01, 'linear');
			doTweenAlpha('flashalpha', 'flash', 0, duration, 'linear');
                end
    end
end
