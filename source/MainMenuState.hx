...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('cubething'));
		...
		/*if(optionShit.length > 6) {
			...
			var menuItem:FlxSprite = new FlxSprite(397, 400);
			...
			menuItem.updateHitbox();
						...
						var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(513, 500);
			menuItem.scale.x = scale;
			menuItem.scale.y = scale;
			...
			menuItem.updateHitbox();
						...
						var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(800, 500);
			menuItem.scale.x = scale;
			menuItem.scale.y = scale;
			...
			menuItem.updateHitbox();
						...
						var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(230, 500);
			menuItem.scale.x = scale;
			menuItem.scale.y = scale;
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Cube Engine");
